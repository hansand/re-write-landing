export function ContextProfilesIllustration({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M60 71a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm0 12c5 0 9 2.5 9 6v1H51v-1c0-3.5 4-6 9-6Z" fill="#792C68" />
      ...
      <rect x="184" y="68" width="36" height="20" rx="10" fill="#963681" />
      <circle cx="210" cy="78" r="7" fill="white" />

      <circle cx="60" cy="158" r="16" fill="#EEF0FF" />
      <path d="M52 152h16v3H52v-3Zm0 6h16v3H52v-3Zm0 6h10v3H52v-3Z" fill="#792C68" />
      ...
      <rect x="184" y="148" width="36" height="20" rx="10" fill="#963681" />
      ...
      <rect x="294" y="228" width="90" height="24" rx="12" fill="#963681" />
